...
public class AccountSearchTest {
    ...
    public void test_accountSearch_TC002() throws FilloException, IOException {
        ...
        Optional<String> user = FilloUtils.getDataByColumnName(testStepsList, "USERNAME");
        Optional<String> passwd = FilloUtils.getDataByColumnName(testStepsList, "PASSWORD");
        ...
        Optional<String> accountNumber = FilloUtils.getDataByColumnName(testStepsList, "ACCOUNTNUMBER");
